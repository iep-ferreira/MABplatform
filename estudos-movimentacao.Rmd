...
carrega()
dir_path <- "./data_sim/"
traj <- select_trajectories(dir_path = dir_path, n_sample = 70)
#class(traj)
```
...
carrega()
# primeira forma
plot_animal_path(trajetory_obj = traj, landscape = mapa_delim, animal = 1:70, weeks = c(1, 2, 3, 4))
# segunda forma 
#plot_animal_path(trajetory_obj = traj, animal = 1:12, weeks = c(1, 2, 3, 4))
```
...
```{r}
result <- calc_centroid_radius(traj, animal = 1:12, weeks = 3:4, ft = 28.8/1000)
